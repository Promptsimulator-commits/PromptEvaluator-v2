...
- The 3 dimension cards must be visually identical — none is ever promoted as "the weak one" (no "point faible" flagging, that concept from the pre-pivot mechanic stays dropped). **Reversed 2026-09-11 (post-Epic-2):** a simple global note — the plain average of the 3 dimension notes, no weighting, no weak-point flag — was added back on explicit PM request, styled like V1's "Note finale." This is a neutral summary number only, not a revival of the "point faible" concept.
...
- No "point faible" (weakest dimension) flagging — that mechanism belonged to the old 4-dimension average-based design and was dropped; each of the 3 dimension cards stands on its own. A plain global average of the 3 notes was reintroduced 2026-09-11 (see above) but never singles out a dimension.
